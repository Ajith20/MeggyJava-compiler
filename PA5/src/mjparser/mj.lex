...
//-[0-9]+         {return new Symbol(sym.UMINUS,new SymbolValue(yyline+1, yychar+1, yytext(),new Integer(yytext())));}
[_|a-zA-Z]+[0-9a-zA-Z]*       {return new Symbol(sym.ID,new SymbolValue(yyline+1, yychar+1, yytext())); }
(/\*([^*]|[\r\n]|(\*+([^*/]|[\r\n])))*\*+/)|(//.*) { }
